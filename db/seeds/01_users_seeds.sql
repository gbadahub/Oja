INSERT INTO users
  (id,first_name,last_name,email, password, phone_number, country, province, city, street, postal)
VALUES
(1,'Georgina', 'Bada', 'georgina@email.com','password123', 555-555-5551, 'Nigeria', 'Lagos','Lagos','Toronto St', 'IJN 123'),
